...
final class HomeBannerTable extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\App\Models\HomeBanner>
     */
    ...
    */
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('name_lower', fn (HomeBanner $model) => strtolower(e($model->name)))
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Room id', 'room_id')->hidden(true, false),
