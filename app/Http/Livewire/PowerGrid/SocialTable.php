...
final class SocialTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\SocialMedia>
     */
    ...
    */
    ...
    {
        return [
            Filter::inputText('platform')->operators(['contains']),
    ...
    */
    ...
    /**
     * PowerGrid SocialMedia Action Buttons.
     *
    ...
    */
    ...
    /**
     * PowerGrid SocialMedia Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($social-media) => $social-media->id === 1)
                ->hide(),
        ];
    }
    */
