...
class ReferansCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.referensmain.index', compact('rooms'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.referensmain.index');
    }
    ...
    public function edit($id)
    {
        ...
        $room = MainCategory::findOrFail($id);
        $rooms = MainCategory::withoutTrashed()->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('message', "Ürün detayları güncellendi!");
