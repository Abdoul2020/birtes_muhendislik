...
return new class extends Migration
{
    ...
    {
        Schema::create('referens_project', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('main_referens_id')->nullable()->unsigned()->constrained('main_categories');
            $table->string('person')->nullable();
            $table->date('baslangic_tarihi')->nullable();
            $table->date('bitis_tarihi')->nullable();
            $table->string('ilgili_kurum')->nullable();
            $table->string('is_veren_company')->nullable();
    ...
    {
        Schema::dropIfExists('referens_project');
    }
};
