...
class RoomSeeder extends Seeder
{
    ...
    private function data(): array
    {
        return [
            ...
            ["order" => 8, "place_id" => 2,"title" => "Psychiatric",        "slug" => "psychiatric",    "person" => "2-10", "duration" => "60", "level" => "Hard",  "banner" => "uploads/rooms/8/banner.webp",   "text_picture" => "uploads/rooms/8/text_picture.webp",   "poster"=>"uploads/rooms/8/poster.webp",       "created_by"=>1, "description" => "<p>A group of friends gathered to have fun on Halloween night and decided to go to the Birtes Mühendislik together.</p> <p>Even though everything seems normal, there is something they don't know. The address they came to for fun is wrong!</p> ",],
