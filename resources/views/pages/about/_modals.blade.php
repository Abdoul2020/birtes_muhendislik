    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <!--begin::Form-->
                <form class="form" id="create_blog_form" action="{{ route('admin.about.store') }}" novalidate method="POST"  enctype="multipart/form-data">
                    @csrf
                    <!--begin::Title input-->
                    <div class="mb-7">
                    ...
                    <div class="d-flex flex-column mb-8">
                        ...
                        <div class="form-floating">
                            <textarea name="about_Text" data-kt-autosize="true" class="form-control" id="floatingContentDescription"></textarea>
                        </div>
                        <!--end::Input group-->
                    </div>
