<x-default-layout>
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 col">
        ...
        @include('pages.tripadvisor._toolbar')
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="İçerik Ara"/>
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
            ...
            @endif
                ...
                @endif
                    ...
                    <!--begin::Table-->
                    @livewire('power-grid.tripadvisor-table')
                    <!--end::Table-->
    ...
    @include('pages.tripadvisor._modals')
