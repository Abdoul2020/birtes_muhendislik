    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_form_room" class="form" action="{{ route('admin.projects.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-10">
                            <label for="level" class="form-label"> Proje Durumu Seçiniz </label>
                            <select class="form-select" id="level" name="level" required>
                                <option value="devameden"> Devam Eden</option>
                                <option value="tamamlanan">Tamamlanan</option>
                                <option value="perakendeproje">Perakende Projeleri</option>
                            </select>
                        </div>
