            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form method="post" id="contentForm" enctype="multipart/form-data"
                        action="{{ route('admin.projects.update', $room->id) }}">
                        @csrf @method('patch')
                            ...
                            <div class="row g-9">
                                ...
                                <div class="col-md-12 fv-row">
                                    <div class="form-floating mb-7 fv-row">
                                        ...
                                        <label class="required" for="platform">Proje Durumu</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-10">
                                    ...
                                    <input type="date" name="baslangic_tarihi" id="baslangic_tarihi"
                                        ...
                                        value="{{ old('baslangic_tarihi', optional($room)->baslangic_tarihi ? $room->baslangic_tarihi->format('Y-m-d') : date('Y-m-d')) }}"
                                ...
                                <div class="col-md-6 mb-10">
                                    ...
                                    <input type="date" name="bitis_tarihi" id="bitis_tarihi"
                                        class="form-control form-control-solid"
                                        value="{{ old('bitis_tarihi', optional($room)->bitis_tarihi ? $room->bitis_tarihi->format('Y-m-d') : date('Y-m-d')) }}"
                                ...
                                <div class="col-md-6 mb-10">
                                    ...
                                    <input type="text" name="ilgili_kurum" id="ilgili_kurum"
                                        class="form-control form-control-solid"
                                        value="{{ old('ilgili_kurum', optional($room)->ilgili_kurum) }}"
                                ...
                                <div class="col-md-6 mb-10">
                                    ...
                                    <textarea name="proje_kapsami" id="proje_kapsami" rows="3"
                                        class="form-control form-control-solid"
                                        placeholder="Proje Kapsamı">{{ old('proje_kapsami', optional($room)->proje_kapsami) }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12 mb-10">
                                    ...
                                    <input type="text" name="yer" id="yer"
                                        class="form-control form-control-solid"
                                        value="{{ old('yer', optional($room)->yer) }}"
                                        placeholder="Yer" />
                                </div>
