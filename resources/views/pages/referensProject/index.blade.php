<x-default-layout>
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 col">
        ...
        @include('pages.referensProject._toolbar')
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <!--begin::Card title-->
                    <!--begin::Card toolbar-->
                    @include('pages.referensProject._card_toolbar')
                    <!--end::Card toolbar-->
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                ...
                @endif
                    ...
                    @livewire('power-grid.referens-projects-table')
    ...
    @include('pages.referensProject._modals')
</x-default-layout>
