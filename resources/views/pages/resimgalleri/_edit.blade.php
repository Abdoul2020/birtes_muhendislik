            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form method="post" id="contentForm" enctype="multipart/form-data"
                        action="{{ route('admin.ressimgalleri.update', $room->id) }}">
                        @csrf @method('patch')
                            ...
                            <div class="row g-9">
                                ...
                                <div class="col-md-6 fv-row">
                                    <div class="form-floating mb-7 fv-row">
                                        ...
                                        <label class="required " for="title"> Proje Resim Gallerisi Adı</label>
                                    </div>
                                </div>
                                <!--end::Col-->
                                    ...
                                    <div class="form-floating mb-7 fv-row">
                                        <select name="level" id="level" class="form-select form-select-solid" required>
                                            ...
                                            @foreach($mainProjects as $project)
                                                <option value="{{ $project->id }}" {{ $room->level == $project->id ? 'selected' : '' }}>{{ $project->title }}</option>
                                            @endforeach
                                        </select>
                                        <label class="required" for="platform">Bağlı Olan Proje</label>
                                    </div>
                                </div>
