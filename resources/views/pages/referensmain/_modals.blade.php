    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_form_room" class="form" action="{{ route('admin.referensmain.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12 mb-10">
                        <label for="title" class="required form-label"> Kategori Adı </label>
