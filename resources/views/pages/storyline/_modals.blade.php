            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <form class="form" id="create_storyline_form" action="{{ route('admin.storyline.store') }}" method="POST">
                    ...
                    <div class="mb-7">
                        ...
                        <input type="text" class="form-control" id="header_title" name="header_title" placeholder="Açıklama  Başlığı" required>
                    </div>
                    ...
                    <!-- Room select input -->
                    <div class="mb-7">
                        <label for="room" class="form-label">Açıklama Hizmeti</label>
