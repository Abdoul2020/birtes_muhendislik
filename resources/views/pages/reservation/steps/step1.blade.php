...
<div data-kt-stepper-element="content">
    <div class="w-100">
        ...
        <div class="fv-row mb-15" data-kt-buttons="true">
            ...
            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 ">
                ...
                <span class="d-flex">
                    ...
                    <!--begin::Info-->
                    <span class="ms-4">
                        <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Turkmenistan</span>
                        <span class="fw-semibold fs-4 text-muted">Turkmenistan Ürünler</span>
                    </span>
                    <!--end::Info--></span>
                <!--end::Label-->
            </label>
        ...
        <div class="fv-row mb-15" data-kt-buttons="true">
            ...
            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 ">
                <!--begin::Input-->
                <input class="btn-check" type="radio" name="place_id" value="3" />
                <!--end::Input-->
                <!--begin::Label-->
                <span class="d-flex">
                    <!--begin::Icon-->
                    ...
                    <!--begin::Info-->
                    <span class="ms-4">
                        <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Almanya</span>
                        <span class="fw-semibold fs-4 text-muted">Almanya Ürünler</span>
                    </span>
                    <!--end::Info--></span>
                <!--end::Label-->
            </label>
        ...
        <div class="fv-row mb-15" data-kt-buttons="true">
            ...
            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 ">
                ...
                <span class="d-flex">
                    ...
                    <!--begin::Info-->
                    <span class="ms-4">
                        <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Rusya</span>
                        <span class="fw-semibold fs-4 text-muted">Rusya Ürünler</span>
                    </span>
                    <!--end::Info--></span>
                <!--end::Label-->
            </label>
