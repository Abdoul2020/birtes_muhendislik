...
@section('title','Black Out - Scariest Escape Rooms | Franchise Opportunities')
@section('meta_tags')
    <!-- Primary Meta Tags -->
    <title>Black Out - Scariest Escape Rooms | Franchise Opportunities</title>
    <meta name="title" content="Black Out - Scariest Escape Rooms | Franchise Opportunities">
    <meta name="description" content="Join the Black Out franchise and bring the scariest escape room experience to your city. Partner with the leading escape room brand in Dubai and UAE and become a part of our success.">
    <meta name="keywords" content="Black Out franchise, escape room franchise, Black Out escape rooms, scariest escape rooms UAE, Dubai franchise opportunities, immersive escape room business, escape room investment">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://black-out.ae/franchise">
    <meta property="og:title" content="Black Out - Scariest Escape Rooms | Franchise Opportunities">
    <meta property="og:description" content="Explore Black Out franchise opportunities and bring the thrill of immersive escape rooms to your city. Join the most successful escape room brand in Dubai and the UAE.">
    <meta property="og:image" content="{{ asset('img/logo/franchise-meta-logo.png') }}">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://black-out.ae/franchise">
    <meta property="twitter:title" content="Black Out - Scariest Escape Rooms | Franchise Opportunities">
    <meta property="twitter:description" content="Become a part of the Black Out franchise and introduce the most thrilling escape room experience in your city. Learn more about our franchise opportunities.">
    <meta property="twitter:image" content="{{ asset('img/logo/franchise-meta-logo.png') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-4">
                                            ...
                                            <div class="checkbox-container mb-4">
                                                ...
                                                <a href="{{route('dubai.terms')}}" target="_blank" class="redirect-icon">
