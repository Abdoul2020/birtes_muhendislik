...
<head>
    ...
    <title>@yield('title', 'Blackout Dubai')</title>
    @yield('meta_tags')
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-1XZ33JE96Z"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
    ...
    @include('site.dubai.layouts.css')
    @yield('styles')
    @livewireStyles
...
@endif --}}
 ...
 @include('site.dubai.layouts.header2') --}}
        ...
        <!-- main-area-end -->
        <!-- footer-area -->
        @include('site.dubai.layouts.footer')
        <!-- footer-area-end -->
