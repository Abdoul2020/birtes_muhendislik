    ...
    <section class="banner-section" style="padding-left: 0px !important; padding-right: 0px !important;">
        <div class="banner-carousel owl-theme owl-carousel">
            ...
            <div class="slide-item">
                <div class="image-layer" style="background-image:url({{ asset($datas->banner) }}?{{ time() }})"> </div>
                ...
                <div class="row clearfix" >
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        <div class="d-none d-lg-block">
                            ...
                            <input name="date" type="text" id="datepicker" style="display: none!important;"
                                onchange="dateChanged(this)" />
                        </div>
                    </div>

                    <div class="col-12 d-block d-lg-none " style="">

                        <div class="featured-game-content game__content_item text-center" style="margin-top: 0px;">
                            <h2 class="mb-3">{{ $datas->title }}</h2>
                            <div class="featured-game-meta p-0 m-0 justify-content-center text-center" style="width: 100%; font-size: 20px; font-weight: 900;"> <i
                    ...
                    <div class="col-12 d-lg-none d-xl-none d-sm-none d-md-none  select__number_bottom w-full mt-5">
                        <div class="w-full  d-flex flex-column justify-content-center align-items-center" style="">
                            <span
                                class="span__select" style="color: #ffff;">Select number of
                                players:
                            </span>
                            <div class="red__bull_number w-full" style="display: flex; gap: 2px; justify-content:space-around">
                            ...
                            <div>
                                <div style="display: flex; gap: 8px; cursor: pointer; margin-top:10px">
                                    <h5 style="font-size: 25px;">2024</h5>
                                    <i class="fa-solid fa-calendar-days" style="color: #ffff; font-size: 25px; " onclick="openCalendar()"></i>
                                </div>
                                <input name="date" type="text" id="datepicker" style="display: none!important;"
                                    onchange="dateChanged(this)" />
                            </div>
                                ...
                                <div class="row "
                                    ...
                                    <div class="col-12">
                                        <div class="featured-game-item image_Item">
                                            <div class="featured-game-thumb"> <img src="{{ asset($datas->poster) }}?{{ time() }}"
