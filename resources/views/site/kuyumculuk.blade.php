 ...
 <div class="container-fluid page-header mb-5 p-0" style="background-image: url( {{ asset('assets/site/img/inside_page.jpg') }});">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown"> Kuyumculuk</h1>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-12 pt-4" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100" src="{{ asset('assets/site/img/kuyum.jpg') }}" style="object-fit: cover;" alt="">
            ...
            <div class="row g-5 mt-3">
                <div class="col-lg-12 mt-5">
                    ...
                    <h1 class="mb-4"><span class="text-primary"></span> Kuyumculuk Hizmeti</h1>
                    <p class="mb-4">
