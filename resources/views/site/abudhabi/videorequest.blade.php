...
@section('title',' Black Out Video Request - Scariest Escape Rooms in Abu Dhabi')
@section('meta_tags')
    <!-- Primary Meta Tags -->
    <meta name="title" content="Black Out - Scariest Escape Rooms in Dubai & Abu Dhabi & Abu Dhabi">
    <meta name="description" content="Experience the scariest escape rooms in Dubai & Abu Dhabi and Abu Dhabi at Black Out. Gather your team and immerse yourself in thrilling escape games with live actors.">
    <meta name="keywords" content="Black Out, escape rooms Dubai & Abu Dhabi, escape rooms Abu Dhabi, scariest escape rooms, live actor escape games, horror escape rooms, Black Out UAE, Dubai & Abu Dhabi adventure activities">
    ...
    <meta property="og:description" content="Immerse yourself in the scariest escape rooms in Dubai & Abu Dhabi and Abu Dhabi. Experience thrilling adventures and solve puzzles with your team at Black Out!">
    ...
    <meta property="twitter:description" content="Black Out offers the scariest and most immersive escape room experiences in Dubai & Abu Dhabi and Abu Dhabi. Book now for a thrilling adventure with live actors!">
...
@section('styles')
    <style>
        .checkbox-container {
            ...
            align-items: center;
            padding: 12px;
            /* Adjusted to give overall padding */
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="field-group mb-2" style="width: 100%;">
                                                ...
                                                <select name="store" id="city" class="formbold-form-input">
                                                    <option value="1">Dubai & Abu Dhabi</option>
                                            ...
                                            <div class="field-group formbold-mb-5 mb-2" style="width: 100%;">
                                                ...
                                                <div class="formbold-form-input flex items-center justify-between"
                                                    ...
                                                    <label for="video-type-{{ $video_price->id }}"
                                                        ...
                                                        <input type="radio" name="video_type"
                                                            id="video-type-{{ $video_price->id }}"
                                                            value="{{ $video_price->title == 'Short Video' ? 1 : 2 }}">
