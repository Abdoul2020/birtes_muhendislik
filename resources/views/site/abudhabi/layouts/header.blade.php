                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                ...
                                <ul class="navigation clearfix d-flex flex-column flex-lg-row align-items-center justify-content-between">
                                    ...
                                    <li class>
                                        <a href="{{ route('supernatural.index') }}" target="_blank">Supernatural</a>
                                    </li>

                                    <li class><a href="{{ route('abudhabi.blog') }}">BLOG</a>
                                    ...
                                    <li class="redButtonNav glitch d-flex align-items-center justify-content-between">
                                        <a href="{{ route('rooms.abudhabi') }}" class="theme-btn btn-style-one" style><span class="btn-title" style="background: transparent; padding: 5px 20px; border-radius:30px !important; border:.15rem solid #ffffffb0; font-weight:700">
                                                BOOK NOW</span></a>
                                    </li>
                                    ...
                                    <li class="redButtonNav d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="{{ route('homepage.index') }}" class="theme-btn btn-style-one" style><span class="btn-title" style="background: transparent; padding: 5px 40px;border-radius:30px !important;border:.15rem solid #ffffffb0;">
                                                Dubai</span></a>
                                    </li>
        ...
        <div class="auto-container clearfix">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="logo pull-left">
                    <a href="{{ route('homeabudhabi.index') }}" title><img src="{{ asset('assets/site/images/newImages/newImage1.webp') }}" alt="Black-out Rooms in Abudhabi | Black-Out" title></a>
                </div>
