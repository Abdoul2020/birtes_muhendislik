...
@section('title', 'Escape Rooms in Abu Dhabi | Black Out - Thrilling Horror Adventures')


@section('meta_tags')
    <!-- Primary Meta Tags -->
    <title>Escape Rooms in Abu Dhabi | Black Out - Thrilling Horror Adventures</title>
    <meta name="title" content="Escape Rooms in Abu Dhabi | Black Out - Thrilling Horror Adventures">
    <meta name="description" content="Discover the largest and scariest escape rooms in Abu Dhabi at Black Out. Experience live-actor horror escape games designed to thrill and challenge you.">
    <meta name="keywords" content="escape rooms Abu Dhabi, horror escape games, live actor escape rooms, scariest escape rooms Abu Dhabi, Black Out escape games, haunted escape room Abu Dhabi, thrilling activities Abu Dhabi, team-building escape rooms, adventure escape games UAE">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Escape Rooms in Abu Dhabi | Black Out - Thrilling Horror Adventures">
    <meta property="og:description" content="Black Out presents the largest and scariest escape rooms in Abu Dhabi with live actors. Immerse yourself in thrilling horror adventures and challenging puzzles.">
    <meta property="og:image" content="{{ asset('assets/site/images/meta/escape-rooms-abu-dhabi.png') }}">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="Escape Rooms in Abu Dhabi | Black Out - Thrilling Horror Adventures">
    <meta property="twitter:description" content="Step into Black Out's live-actor escape rooms in Abu Dhabi for the ultimate horror escape game experience. Get ready for challenging puzzles and unforgettable adventures.">
    <meta property="twitter:image" content="{{ asset('assets/site/images/meta/escape-rooms-abu-dhabi.png') }}">
...
<div class="trip-advisor-logo-anim trip-advisor-logo-landing">
    <a target="_blank" href="https://www.tripadvisor.com/Attraction_Review-g294013-d24859666-Reviews-BlackOut_Realistic_Horror_Escape_Games-Abu_Dhabi_Emirate_of_Abu_Dhabi.html">
        <img src="https://static.tacdn.com/img2/travelers_choice/widgets/tchotel_2024_L.png" alt="Blackout tripadvisor 2024 travellers choice award">
    </a>
</div>
            ...
            <div class="content-box">
                <div class="content">
                    ...
                    <div class="link-box book_now_button" style="text-align: center">
                        ...
                        <a href="{{ route('rooms.abudhabi') }}" class="theme-btn btn-style-one">
                        ...
                        <div class="featured-game-item mb-30">
                            ...
                            <div class="featured-game-content">
                                ...
                                <div class="featured-game-meta">
                                    <span style="font-weight: 400;"><i class="fas fa-clock"></i>{{ $room->duration }}</span>
                                    <span style="font-weight: 400;"><i class="fas fa-hammer"></i>{{ $room->level }}</span>
                                    <span style="font-weight: 400;"><i class="fas fa-running"></i>{{ $room->person }}</span>
                                </div>
                            </div>
                            <div class="featured-game-content featured-game-overlay-content">
                                <div class="featured-game-icon"><img src="{{ asset($room->text_picture) }}?{{ time() }}" alt="{{ $room->title }} Title"></div>
                                <div class="featured-game-meta">
                         ...
                         <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                             <div class="review__block"
                                 ...
                                 <div class="review__block-info">
                                     <div class="review__block-stars" style="text-align: center; margin-bottom: 10px;">
                                         @for ($i = 0; $i < 5; $i++)
                                     ...
                                     <div class="text" style="text-align: center;">"{{ $review->comments }}"</div>
                                     <div class="info clearfix" style="text-align: center; margin-top: 10px;">
                                         <span class="name" style="font-weight: bold; color: #333;">{{ $review->name }}</span>&ensp;-&ensp;
                                         <span class="date" style="color: #777;">{{ \Carbon\Carbon::parse($review->comment_date)->format('d M, Y') }}</span>&ensp;-&ensp;&ensp;-&ensp;
                                         <span>
